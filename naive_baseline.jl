...
# ╔═╡ c123696e-1295-455d-9568-f4fbe74de146
begin
	jldfilename = joinpath("gram_matrices", "BeeTox_fixed_length_rw_kernel_1.jld2")
...
# ╔═╡ 3a98231d-05f5-4309-a610-ad05f39859ef
begin
	fig = Figure()
	ax = Axis(fig[1, 1], xlabel="molecular weight [g/mol]", ylabel="# molecules")
	hist!(mw[toxicity .== "Toxic"], label="toxic")
	hist!(mw[toxicity .== "Nontoxic"], label="non-toxic")
	axislegend()
	fig
end

# ╔═╡ 521fa14b-6c71-4c95-88da-f934589ddd34
begin
	dt = DecisionTreeClassifier(max_depth=1)
	dt.fit([[mw_i] for mw_i in mw], toxicity)
	dt.score([[mw_i] for mw_i in mw], toxicity)
end
