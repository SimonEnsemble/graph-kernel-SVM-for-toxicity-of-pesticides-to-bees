...
# ╔═╡ ef80b53f-4fbf-4caa-8f47-c59ffb2d6801
using LinearAlgebra, CairoMakie, CSV, DataFrames, ScikitLearn, StatsBase, Random, NPZ

# ╔═╡ 21501a20-bc86-11ec-171a-2ff11e972999
md"# Maccskeys fingerprint with TanimotoSimilarity"

# ╔═╡ d1d487ca-9e25-44e9-86ec-117cabe863ec
import MLJBase: partition

# ╔═╡ 2115f18c-3145-452a-a04f-c8491b49078e
Random.seed!(97330)

# ╔═╡ b93f2715-fb0b-43b2-8c20-3f30ed853b16
"""
...
# ╔═╡ eff438da-07ab-41e2-86da-4ded4a857dd9
begin
	@sk_import svm : SVC
...
# ╔═╡ b08ed4dc-7c78-4177-b2f9-35ef4919994a
K = npzread("MACCSTSK.npy")

# ╔═╡ 12416a1f-e4bd-4cf9-a74e-9cfd80284446
begin
	toxicity = CSV.read("new_smiles.csv", DataFrame)[:, "Outcome"]
	class_to_int = Dict("Toxic" => 1, "Nontoxic" => -1)
	y = Vector(map(t -> class_to_int[t], toxicity))
end

# ╔═╡ 224ff2c5-389d-4c64-a1b8-9c549fbc276d
...
# ╔═╡ 7c59dbaa-c072-4c41-b2ce-2aa3a44f9654
...
# ╔═╡ 3b6bb948-e3e7-4e61-9a8a-1b858acc459d
begin
	n_folds = 3
	n_runs = 100
	Cs = 10 .^ range(-1, 3, 15)
...
# ╔═╡ ccf8618e-ac23-4d0b-b2f7-3b1addea76f6
acc_test = mean(accuracies)

# ╔═╡ 8086d11a-9d79-4096-a21e-c26e71ac1963
pre_test = mean(precisions)

# ╔═╡ 4e5dc0f4-9cba-4e36-892c-75823a3dd9e7
rec_test = mean(recalls)

# ╔═╡ 9161c4fd-ff32-4acb-895b-1fc65ef859b8
f1_test = mean(f1_scores)
...
git-tree-sha1 = "45178401f23894c530f330a4dbf286f0b698c5b7"
