...
# ╔═╡ 57ac8991-741c-4bc2-87c0-39d0b7f5e7e7
using Graphs, LinearAlgebra, MetaGraphs, Xtals, GraphPlot

# ╔═╡ 2bf97600-d2aa-4e1f-ace3-a000ea56a932
include("RWK.jl")

# ╔═╡ 7661f950-41ae-11ec-177d-477f5a2af273
pwd()

# ╔═╡ 841880c8-a3d2-4add-8464-907b46cc732a
begin
	A11 = read_xyz("all_cages\\A11.xyz")
	B11 = read_xyz("all_cages\\B11.xyz")
	B13 = read_xyz("all_cages\\B13.xyz")
	B15 = read_xyz("all_cages\\B15.xyz")
	B18 = read_xyz("all_cages\\B18.xyz")
end
